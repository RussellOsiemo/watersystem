                ...
                <section id="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="col-lg-4">
                                <button type="button" class="btn btn-white save-event waves-effect waves-light"> <a href="addstaff.php"><h6>Add New Staff Record</h6></a></button></div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="table table-bordered verticle-middle table-responsive-sm">
                                        <thead>
                                            <tr>
                                               ...
                                               <th width="20%" style="color: blueviolet;">National ID Number</th>
                                               <th width="30%" style="color: blueviolet;">Name</th>
                                               <th width="25%" style="color: blueviolet;">Phone Number</th>
                                        ...
                                        <tbody>
                                         ...
                                         while($row=mysqli_fetch_assoc($res)) { ?>
                                            <tr>
                                            <td style="color: black;"> <?php echo $row['id_no']?> </td>
                                            <td style="color: black;"> <?php echo $row['name']?> </td>
                                            <td style="color: black;"> <?php echo $row['phone_no']?> </td>
                                            <td>
                                                    <?php
                                                   
                                                    echo "<a href='addstaff.php?id=".$row['id']."' data-toggle='tooltip' data-placement='top' title='Edit'><i class='fa fa-pencil color-muted' style='color: black;'></i></a>";
                                                        echo '<span class="badge badge-edit" data-toggle="tooltip" data-placement="top" '; 
                                                        echo "<span class='badge badge-delete'><a href='staff.php?type=delete &id=".$row['id']."'><i class='fa fa-close color-danger' style='color: black;'></i></a></span> ";
                                                    ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
