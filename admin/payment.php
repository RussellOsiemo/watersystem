        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a class="sidebar-sub-toggle" href="payment.php"><i class="ti-user"></i> Payments</a></li>
                ...
                <section id="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="col-lg-4">
                                <button type="button" class="btn btn-white save-event waves-effect waves-light"> <a href="addpay.php"><h6>Add New Payment Record</h6></a></button></div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="table table-bordered verticle-middle table-responsive-sm">
                                        <thead>
                                            <tr>
                                               ...
                                               <th width="15%" style="color: blueviolet;">Till Number</th>
                                               <th width="15%" style="color: blueviolet;">Trn Code</th>
                                               <th width="15%" style="color: blueviolet;">Ref No</th>
                                        ...
                                        <tbody>
                                         ...
                                         while($row=mysqli_fetch_assoc($res)) { ?>
                                            ...
                                            <td style="color: black;"> <?php echo $row['trn_code']?> </td>
                                            <td style="color: black;"> <?php echo $row['ref_no']?> </td>
